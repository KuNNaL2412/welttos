...
(function() {
  ...
  const DARK = {
    nodePrimary: { r: 0, g: 220, b: 255 },
    nodeSecondary: { r: 139, g: 111, b: 255 },
    nodeAccent: { r: 0, g: 255, b: 160 },
    lineColor: 'rgba(0,220,255,',
    lineAlpha: 0.38,
    nodeAlpha: 0.92,
    scanColor: 'rgba(0,220,255,',
    scanAlpha: 0.075,
    charColor: 'rgba(0,220,255,',
    charAlpha: 0.32
  };
  const LIGHT = {
    nodePrimary: { r: 67, g: 56, b: 202 },
    nodeSecondary: { r: 124, g: 58, b: 237 },
    nodeAccent: { r: 5, g: 150, b: 105 },
    lineColor: 'rgba(67,56,202,',
    lineAlpha: 0.42,
    nodeAlpha: 0.95,
    scanColor: 'rgba(67,56,202,',
    scanAlpha: 0.065,
    charColor: 'rgba(67,56,202,',
    charAlpha: 0.28
  };
...
/* ═══════════════════════════════════════════════
   CUSTOM FORM SUBMISSION + THANK YOU MODAL
═══════════════════════════════════════════════ */
function openModal() {
